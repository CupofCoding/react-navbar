...
import { ReactComponent as BurgerMenu } from '../icons/bars-solid.svg';   
import { ReactComponent as UserGear } from '../icons/user-gear-solid.svg';
// then pass icon={<Icon />} component instead of icon:="X"
    ...
    return (
        ...
        <ul>
            ...
            <Menu>
                ...
                <MenuItem icon={<UserGear />} />
                <MenuItem icon={<BurgerMenu />}> 
